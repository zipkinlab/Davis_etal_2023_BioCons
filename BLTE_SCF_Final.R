...
#----------------------------------------------------------------------------------------------------------------------------------------
# ~~~~ save output for use later ~~~~
# save.image(file="nao.st.Rdata")
# save.image(file="nao.lt.Rdata")
# save.image(file="nao.st.fec.Rdata")
# save.image(file="nao.lt.fec.Rdata")
# save.image(file="nao.lt.phij.Rdata")
# save.image(file="nao.st.phij.Rdata")
# save.image(file="nao.st.phia.Rdata")
# save.image(file="nao.lt.phia.Rdata")
# save.image(file="nao.lt.all.Rdata")
# save.image(file="nao.st.all.Rdata")
