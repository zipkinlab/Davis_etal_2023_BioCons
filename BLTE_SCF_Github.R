...
nao.st.phij <- jags(jags.data, inits, parameters, "blte_nao_bpva_phij", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE, store.data = TRUE)
...
nao.st.fec <- jags(jags.data, inits, parameters, "blte_nao_bpva_fec", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE, store.data = TRUE)
...
nao.lt <- jags(jags.data, inits, parameters, "blte_nao_bpva_null", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE, store.data = TRUE)
